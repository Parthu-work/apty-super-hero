...
import { setAptyIntegrationConfig } from "@aipexstudio/browser-runtime";
...
setAptyIntegrationConfig({
  studioExtensionId: import.meta.env.VITE_APTY_STUDIO_EXTENSION_ID || undefined,
  widgetExtensionId: import.meta.env.VITE_APTY_WIDGET_EXTENSION_ID || undefined,
  clientExtensionId: import.meta.env.VITE_APTY_CLIENT_EXTENSION_ID || undefined,
